	        ...
	        <div class="form-group">
	          <div class="input-group">
	            <input class="pass_field" class="form-control" type="password" name="password_1" placeholder="Password"
	              style="width:100%;">
	            <img class="show_pass" src="./static/images/eye-fill.svg" alt="eye"
	              style="position: absolute;right: 15px;top: 20px;">
	            <input class="pass_field" class="form-control" type="password" name="password_2"
	              placeholder="Password confirmation" style="width:100%;">
	            <img class="show_pass" src="./static/images/eye-fill.svg" alt="eye"
	              style="position: absolute;right: 15px;top: 90px;">
