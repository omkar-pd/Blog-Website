              ...
              <form class="form-card" method="POST" action="edit_user_profile.php">
                ...
                <div class="row justify-content-between text-left">
                  <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">First
                      ...
                      placeholder="Enter your first name" value="<?php echo $user['firstName'] ?>" required> </div>
                  <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Last
                      ...
                      placeholder="Enter your last name" value="<?php echo $user['lastName'] ?>" required> </div>
                </div>
                <div class="row justify-content-between text-left">
                  <div class="form-group col-sm-6 flex-column d-flex"> <label
                      class="form-control-label px-3">Address<span class="text-danger"> *</span></label> <textarea
                      name="address" id="address" cols="10" rows="1" required><?php echo $user['address']?></textarea>
                  </div>
                  <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Phone
                      number<span class="text-danger"> *</span></label> <input type="text" id="mobno" name="mobno"
                      placeholder="Mobile Number" value="<?php echo $user['mobno'] ?>" required> </div>
                </div>
                <div class="row justify-content-between text-left">
                  <div class="form-group  flex-column d-flex"> <label class="form-control-label px-3">Description<span
                        class="text-danger"> *</span></label> <textarea name="description" id="description" cols="70"
                      rows="5" required><?php echo $user['description'] ?></textarea> </div>
                </div>
                <div class="row justify-content-between text-left">
                  <div class="form-group col-12 flex-column d-flex"> <label class="form-control-label px-3">Social
                      Links</label>
                ...
                <div class="row justify-content-end">
                  <div class="form-group col-sm-6"> <button type="submit" name="update_user_profile"
                      class="btn-block btn-primary">Update Profile</button> </div>
                </div>
              </form>
            </div>
          </div>
