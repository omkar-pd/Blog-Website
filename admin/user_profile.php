    ...
    <body>
      ...
      <div class="user-content">
        ...
        <div class="user-blogs">
          <a href="../show_post.php?id=<?php echo $user['id']; ?> " target="_blank">
            <h6> <?php echo $user['title']; ?></h6>
          </a>
          <span><?php echo date("F j, Y ", strtotime($user["created_at"])); ?></span>
          <img src="<?php echo BASE_URL . '/static/images/' . $user['image']; ?>" class="post_image" alt="Image">
          <a href="../show_post.php?id=<?php echo $user['id']; ?>" target="_blank"> <button
              class="continue-reading">Continue Reading</button> </a>
        </div>
        <?php }?>
      </div>
      <?php  
