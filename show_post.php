...
<body>
  ...
  <div class="container col-12">
    ...
    <div class="show-post container-fluid w-50 ml-auto mr-auto mt-5 bg-light ">
      ...
      <p class="d-flex justify-content-end">Author Name: <a
          href="./admin/user_profile.php?userid=<?php echo $post['user_id'] ?>"> <?php echo $row['username'] . " " ?>
        </a></p>
      <?php } ?>
      ...
      <div class="d-flex justify-content-between pt-2"><span class="lead">Created At:
          <?php echo $post['created_at'] ?></span><span class="lead">Updated At:
          <?php echo $post['updated_at'] ?></span> </div>
    </div>
  </div>
  </div>
  <?php endforeach ?>
        ...
        <div class="card p-3">
          <div class="d-flex justify-content-between align-items-center">
            <div class="user d-flex flex-row align-items-center"> <img
                src="https://img.icons8.com/bubbles/100/000000/user.png" width="30"
                class="user-img rounded-circle mr-2"> <span><small class="font-weight-bold text-primary"><a
                    href="./admin/user_profile.php?userid=<?php echo $info['user_id'] ?>">
                    <?php echo $info['username'] ?> </a></small> <small
                  class="font-weight-bold ml-2"><?php echo $info['comment'] ?></small></span> </div>
  ...
  <div class="d-flex flex-column justify-content-center align-items-center">
    ...
    <button class="btn btn-info" style="max-width: 215px;"><a class="text-dark" href="./login.php">Click here to
        login</a></button>
    <button class="btn btn-info" style="max-width: 215px;"><a class="text-dark" href="./register.php">Click here to
        register</a></button>
  </div>
  <?php } ?>
